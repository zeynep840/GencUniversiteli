...
public class EgitimSorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_egitim_sor);
        PostsRef5= FirebaseDatabase.getInstance().getReference().child("EgitimSor");
        ...
        camera5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent post5=new Intent(EgitimSorActivity.this,EgitimSorPostsActivity.class);
                startActivity(post5);
                finish();
            }
        });
    ...
    private void DisplayAllUserPosts5() {
        final FirebaseRecyclerAdapter<EgitimSorPosts, EgitimSorPostsViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<EgitimSorPosts, EgitimSorPostsViewHolder>(
                EgitimSorPosts.class,
                R.layout.all_hukuk_sor_post_layout,
                EgitimSorPostsViewHolder.class,
                PostsRef5
        ) {
            @Override
            protected void populateViewHolder(EgitimSorPostsViewHolder viewHolder, EgitimSorPosts model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent clickPostIntent=new Intent(EgitimSorActivity.this,EgitimSorClickPostActivity.class);
                ...
                viewHolder.CommentPostButton.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent commentPostIntent=new Intent(EgitimSorActivity.this,EgitimSorCommentActivity.class);
...
//post sayfasında gözükmeyi sağlar
    ...
    public static class EgitimSorPostsViewHolder extends RecyclerView.ViewHolder {
        View mView;
        Button CommentPostButton;


        public EgitimSorPostsViewHolder(@NonNull View itemView) {
            super(itemView);
            mView = itemView;
