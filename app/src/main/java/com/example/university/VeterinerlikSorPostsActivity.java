...
public class VeterinerlikSorPostsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent geriIntent=new Intent( VeterinerlikSorPostsActivity.this,VeterinerlikSorActivity.class);
    ...
    private void ValidatePost1Info() {
        ...
        postsRef=FirebaseDatabase.getInstance().getReference().child("VeterinerlikSor");
                ...
                postsRef.child(current_user_id+postRandom).updateChildren(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()){
                            startActivity(new Intent(VeterinerlikSorPostsActivity.this,VeterinerlikSorActivity.class));
                            finish();

                        }
                        else{
                            Toast.makeText(VeterinerlikSorPostsActivity.this,"Eror",Toast.LENGTH_SHORT).show();
