...
public class MimarlikProjeOnerileriCommentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mimarlik_proje_onerileri_comment);
        Post_Key = getIntent().getExtras().get("PostKey2").toString();
        postsRef = FirebaseDatabase.getInstance().getReference().child("MimarlikProjeOnerileri").child(Post_Key).child("MimarlikProjeOnerileriComments");
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (dataSnapshot.exists()) {
                            ...
                            if (TextUtils.isEmpty(comments)) {
                                Toast.makeText(MimarlikProjeOnerileriCommentActivity.this, "Boş Yorum Gönderemezsin...", Toast.LENGTH_SHORT).show();
                            } else {
                                ...
                                postsRef.child(postRandom).updateChildren(commentsMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()) {
                                            Toast.makeText(MimarlikProjeOnerileriCommentActivity.this, "Başarılı bir şekilde yüklendi", Toast.LENGTH_SHORT).show();
                                        } else {
                                            Toast.makeText(MimarlikProjeOnerileriCommentActivity.this, "Eror", Toast.LENGTH_SHORT).show();
    ...
    protected void onStart() {
        ...
        super.onStart();
        FirebaseRecyclerAdapter<MimarlikProjeOnerileriComment, MimarlikProjeOnerileriCommentViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<MimarlikProjeOnerileriComment, MimarlikProjeOnerileriCommentViewHolder>
                (MimarlikProjeOnerileriComment.class,
                        R.layout.all_mimarlik_proje_onerileri_comment_layout,
                        MimarlikProjeOnerileriCommentViewHolder.class,
                        postsRef

                )
        {
            @Override
            protected void populateViewHolder(MimarlikProjeOnerileriCommentViewHolder viewHolder, MimarlikProjeOnerileriComment model, int position) {
    ...
    public static class MimarlikProjeOnerileriCommentViewHolder extends RecyclerView.ViewHolder{
        View mView;

        public MimarlikProjeOnerileriCommentViewHolder(@NonNull View itemView) {
            super(itemView);
            mView=itemView;
        }
        //setler yazılacak
