...
public class MimarlikSorPosts {
    public String postid3,postimage3,description3,profileimage,publisher3,date3,time3,username;
    public MimarlikSorPosts(){

    }
    public MimarlikSorPosts(String postid3,String date3,String time3,String publisher3,String username,String postimage3,String description2,String profileimage){
