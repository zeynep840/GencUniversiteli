...
public class IsletmeSosyalAktivitelerClickPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_isletme_sosyal_aktiviteler_click_post);
        ...
        ClickPostRef= FirebaseDatabase.getInstance().getReference().child("IsletmeSosyalAktiviteler").child(PostKey);
    ...
    private void EditCurrentPost(String description) {
        AlertDialog.Builder builder=new AlertDialog.Builder(IsletmeSosyalAktivitelerClickPostActivity.this);
        builder.setTitle("DÜZENLE");
        final EditText InputField=new EditText(IsletmeSosyalAktivitelerClickPostActivity.this);
        ...
        builder.setPositiveButton("Güncelle", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(IsletmeSosyalAktivitelerClickPostActivity.this,"Post başarıyla güncellendi",Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void SendUserToMainActivity() {
        Intent mainIntent = new Intent(IsletmeSosyalAktivitelerClickPostActivity.this,IsletmeSosyalAktivitelerActivity.class);
