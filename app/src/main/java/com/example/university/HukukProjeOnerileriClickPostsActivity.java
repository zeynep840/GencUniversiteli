...
public class HukukProjeOnerileriClickPostsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hukuk_proje_onerileri_click_posts);
        ...
        ClickPostRef= FirebaseDatabase.getInstance().getReference().child("HukukProjeOnerileri").child(PostKey);
    ...
    private void EditCurrentPost(String description) {
        AlertDialog.Builder builder=new AlertDialog.Builder(HukukProjeOnerileriClickPostsActivity.this);
        builder.setTitle("DÜZENLE");
        final EditText InputField=new EditText(HukukProjeOnerileriClickPostsActivity.this);
        ...
        builder.setPositiveButton("Güncelle", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(HukukProjeOnerileriClickPostsActivity.this,"Post başarıyla güncellendi",Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void SendUserToMainActivity() {
        Intent mainIntent = new Intent(HukukProjeOnerileriClickPostsActivity.this,EgitimSorActivity.class);
