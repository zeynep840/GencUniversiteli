...
public class VeterinerlikSorClickPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_veterinerlik_sor_click_post);
        ...
        ClickPostRef= FirebaseDatabase.getInstance().getReference().child("VeterinerlikSor").child(PostKey);
    ...
    private void EditCurrentPost(String description) {
        AlertDialog.Builder builder=new AlertDialog.Builder(VeterinerlikSorClickPostActivity.this);
        builder.setTitle("DÜZENLE");
        final EditText InputField=new EditText(VeterinerlikSorClickPostActivity.this);
        ...
        builder.setPositiveButton("Güncelle", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(VeterinerlikSorClickPostActivity.this,"Post başarıyla güncellendi",Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void SendUserToMainActivity() {
        Intent mainIntent = new Intent(VeterinerlikSorClickPostActivity.this,EgitimSorActivity.class);
