...
public class HukukSorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hukuk_sor);
        PostsRef5= FirebaseDatabase.getInstance().getReference().child("HukukSor");
        ...
        getSupportActionBar().setTitle("Hukuk Bölümü");
        camera5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent post5=new Intent(HukukSorActivity.this,HukukSorPostsActivity.class);
                startActivity(post5);
                finish();
            }
        });
    ...
    private void DisplayAllUserPosts5() {
        final FirebaseRecyclerAdapter<HukukSorPosts,HukukSorPostsViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<HukukSorPosts, HukukSorPostsViewHolder>(
                HukukSorPosts.class,
                R.layout.all_hukuk_sor_post_layout,
                HukukSorPostsViewHolder.class,
                PostsRef5
        ) {
            @Override
            protected void populateViewHolder(HukukSorPostsViewHolder viewHolder, HukukSorPosts model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent clickPostIntent=new Intent(HukukSorActivity.this,HukukSorClickPostActivity.class);
                ...
                viewHolder.CommentPostButton.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent commentPostIntent=new Intent(HukukSorActivity.this,HukukSorCommentActivity.class);
...
//post sayfasında gözükmeyi sağlar
    ...
    public static class HukukSorPostsViewHolder extends RecyclerView.ViewHolder {
        View mView;
        Button CommentPostButton;


        public HukukSorPostsViewHolder(@NonNull View itemView) {
            super(itemView);
            mView = itemView;
