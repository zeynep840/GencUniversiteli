...
public class VeterinerlikProjeOnerileriPostsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_veterinerlik_proje_onerileri_posts);
        init();
        ...
        backButton1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent geriIntent=new Intent( VeterinerlikProjeOnerileriPostsActivity.this,VeterinerlikProjeOnerileriActivity.class);
    ...
    private void ValidatePost1Info() {
        ...
        postsRef=FirebaseDatabase.getInstance().getReference().child("VeterinerlikProjeOnerileri");
                ...
                postsRef.child(current_user_id+postRandom).updateChildren(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()){
                            startActivity(new Intent(VeterinerlikProjeOnerileriPostsActivity.this,VeterinerlikProjeOnerileriActivity.class));
                            finish();

                        }
                        else{
                            Toast.makeText(VeterinerlikProjeOnerileriPostsActivity.this,"Eror",Toast.LENGTH_SHORT).show();
