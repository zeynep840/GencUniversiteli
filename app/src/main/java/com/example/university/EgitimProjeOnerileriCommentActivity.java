...
public class EgitimProjeOnerileriCommentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_egitim_proje_onerileri_comment);
        Post_Key = getIntent().getExtras().get("PostKey2").toString();
        postsRef = FirebaseDatabase.getInstance().getReference().child("EgitimProjeOnerileri").child(Post_Key).child("EgitimProjeOnerileriComments");
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (dataSnapshot.exists()) {
                            ...
                            if (TextUtils.isEmpty(comments)) {
                                Toast.makeText(EgitimProjeOnerileriCommentActivity.this, "Boş Yorum Gönderemezsin...", Toast.LENGTH_SHORT).show();
                            } else {
                                ...
                                postsRef.child(postRandom).updateChildren(commentsMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()) {
                                            Toast.makeText(EgitimProjeOnerileriCommentActivity.this, "Başarılı bir şekilde yüklendi", Toast.LENGTH_SHORT).show();
                                        } else {
                                            Toast.makeText(EgitimProjeOnerileriCommentActivity.this, "Eror", Toast.LENGTH_SHORT).show();
    ...
    protected void onStart() {
        ...
        super.onStart();
        FirebaseRecyclerAdapter<EgitimProjeOnerileriComment, EgitimProjeOnerileriCommentViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<EgitimProjeOnerileriComment, EgitimProjeOnerileriCommentViewHolder>
                (EgitimProjeOnerileriComment.class,
                        R.layout.all_egitim_proje_onerileri_comment_layout,
                        EgitimProjeOnerileriCommentViewHolder.class,
                        postsRef

                )
        {
            @Override
            protected void populateViewHolder(EgitimProjeOnerileriCommentViewHolder viewHolder, EgitimProjeOnerileriComment model, int position) {
    ...
    public static class EgitimProjeOnerileriCommentViewHolder extends RecyclerView.ViewHolder{
        View mView;

        public EgitimProjeOnerileriCommentViewHolder(@NonNull View itemView) {
            super(itemView);
            mView=itemView;
        }
        //setler yazılacak
