...
public class TipSosyalAktivitelerClickPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tip_sosyal_aktiviteler_click_post);
        ...
        ClickPostRef= FirebaseDatabase.getInstance().getReference().child("TipSosyalAktiviteler").child(PostKey);
    ...
    private void EditCurrentPost(String description) {
        AlertDialog.Builder builder=new AlertDialog.Builder(TipSosyalAktivitelerClickPostActivity.this);
        builder.setTitle("DÜZENLE");
        final EditText InputField=new EditText(TipSosyalAktivitelerClickPostActivity.this);
        ...
        builder.setPositiveButton("Güncelle", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(TipSosyalAktivitelerClickPostActivity.this,"Post başarıyla güncellendi",Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void SendUserToMainActivity() {
        Intent mainIntent = new Intent(TipSosyalAktivitelerClickPostActivity.this,EgitimSorActivity.class);
