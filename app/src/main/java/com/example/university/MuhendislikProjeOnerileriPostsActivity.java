...
public class MuhendislikProjeOnerileriPostsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_muhendislik_proje_onerileri_posts);
        init();
        ...
        backButton1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent geriIntent=new Intent( MuhendislikProjeOnerileriPostsActivity.this,MuhendislikProjeOnerileriActivity.class);
    ...
    private void ValidatePost1Info() {
        ...
        postsRef=FirebaseDatabase.getInstance().getReference().child("MuhendislikProjeOnerileri");
                ...
                postsRef.child(current_user_id+postRandom).updateChildren(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()){
                            startActivity(new Intent(MuhendislikProjeOnerileriPostsActivity.this,MuhendislikProjeOnerileriActivity.class));
                            finish();

                        }
                        else{
                            Toast.makeText(MuhendislikProjeOnerileriPostsActivity.this,"Eror",Toast.LENGTH_SHORT).show();
