...
public class VeterinerlikSosyalAktivitelerClickPostsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_veterinerlik_sosyal_aktiviteler_click_posts);
        ...
        ClickPostRef= FirebaseDatabase.getInstance().getReference().child("VeterinerlikSosyalAktiviteler").child(PostKey);
    ...
    private void EditCurrentPost(String description) {
        AlertDialog.Builder builder=new AlertDialog.Builder(VeterinerlikSosyalAktivitelerClickPostsActivity.this);
        builder.setTitle("DÜZENLE");
        final EditText InputField=new EditText(VeterinerlikSosyalAktivitelerClickPostsActivity.this);
        ...
        builder.setPositiveButton("Güncelle", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(VeterinerlikSosyalAktivitelerClickPostsActivity.this,"Post başarıyla güncellendi",Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void SendUserToMainActivity() {
        Intent mainIntent = new Intent(VeterinerlikSosyalAktivitelerClickPostsActivity.this,VeterinerlikSosyalAktivitelerActivity.class);
