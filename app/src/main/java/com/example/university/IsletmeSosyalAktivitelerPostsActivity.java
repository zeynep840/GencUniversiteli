...
public class IsletmeSosyalAktivitelerPostsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_isletme_sosyal_aktiviteler_posts);
        init();
        ...
        backButton1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent geriIntent=new Intent( IsletmeSosyalAktivitelerPostsActivity.this,IsletmeSosyalAktivitelerActivity.class);
    ...
    private void ValidatePost1Info() {
        ...
        postsRef=FirebaseDatabase.getInstance().getReference().child("IsletmeSosyalAktiviteler");
                ...
                postsRef.child(current_user_id+postRandom).updateChildren(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()){
                            startActivity(new Intent(IsletmeSosyalAktivitelerPostsActivity.this,IsletmeSosyalAktivitelerActivity.class));
                            finish();

                        }
                        else{
                            Toast.makeText(IsletmeSosyalAktivitelerPostsActivity.this,"Eror",Toast.LENGTH_SHORT).show();
