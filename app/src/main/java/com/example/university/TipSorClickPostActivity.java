...
public class TipSorClickPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tip_sor_click_post);
        ...
        ClickPostRef= FirebaseDatabase.getInstance().getReference().child("TipSor").child(PostKey);
    ...
    private void EditCurrentPost(String description) {
        AlertDialog.Builder builder=new AlertDialog.Builder(TipSorClickPostActivity.this);
        builder.setTitle("DÜZENLE");
        final EditText InputField=new EditText(TipSorClickPostActivity.this);
        ...
        builder.setPositiveButton("Güncelle", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(TipSorClickPostActivity.this,"Post başarıyla güncellendi",Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void SendUserToMainActivity() {
        Intent mainIntent = new Intent(TipSorClickPostActivity.this,EgitimSorActivity.class);
