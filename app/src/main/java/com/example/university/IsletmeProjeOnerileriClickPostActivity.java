...
public class IsletmeProjeOnerileriClickPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_isletme_proje_onerileri_click_post);
        ...
        ClickPostRef= FirebaseDatabase.getInstance().getReference().child("IsletmeProjeOnerileri").child(PostKey);
    ...
    private void EditCurrentPost(String description) {
        AlertDialog.Builder builder=new AlertDialog.Builder(IsletmeProjeOnerileriClickPostActivity.this);
        builder.setTitle("DÜZENLE");
        final EditText InputField=new EditText(IsletmeProjeOnerileriClickPostActivity.this);
        ...
        builder.setPositiveButton("Güncelle", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(IsletmeProjeOnerileriClickPostActivity.this,"Post başarıyla güncellendi",Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void SendUserToMainActivity() {
        Intent mainIntent = new Intent(IsletmeProjeOnerileriClickPostActivity.this,EgitimSorActivity.class);
