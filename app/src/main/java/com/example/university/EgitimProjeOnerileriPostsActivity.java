...
public class EgitimProjeOnerileriPostsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_egitim_proje_onerileri_posts);
        init();
        ...
        backButton1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent geriIntent=new Intent( EgitimProjeOnerileriPostsActivity.this,EgitimProjeOnerileriActivity.class);
    ...
    private void ValidatePost1Info() {
        ...
        postsRef=FirebaseDatabase.getInstance().getReference().child("EgitimProjeOnerileri");
                ...
                postsRef.child(current_user_id+postRandom).updateChildren(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()){
                            startActivity(new Intent(EgitimProjeOnerileriPostsActivity.this,EgitimProjeOnerileriActivity.class));
                            finish();

                        }
                        else{
                            Toast.makeText(EgitimProjeOnerileriPostsActivity.this,"Eror",Toast.LENGTH_SHORT).show();
