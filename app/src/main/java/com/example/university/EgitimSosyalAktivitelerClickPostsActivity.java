...
public class EgitimSosyalAktivitelerClickPostsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_egitim_sosyal_aktiviteler_click_posts);
        ...
        ClickPostRef= FirebaseDatabase.getInstance().getReference().child("EgitimSosyalAktiviteler").child(PostKey);
    ...
    private void EditCurrentPost(String description) {
        AlertDialog.Builder builder=new AlertDialog.Builder(EgitimSosyalAktivitelerClickPostsActivity.this);
        builder.setTitle("DÜZENLE");
        final EditText InputField=new EditText(EgitimSosyalAktivitelerClickPostsActivity.this);
        ...
        builder.setPositiveButton("Güncelle", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(EgitimSosyalAktivitelerClickPostsActivity.this,"Post başarıyla güncellendi",Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void SendUserToMainActivity() {
        Intent mainIntent = new Intent(EgitimSosyalAktivitelerClickPostsActivity.this,EgitimSorActivity.class);
