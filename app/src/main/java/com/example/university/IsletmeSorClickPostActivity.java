...
public class IsletmeSorClickPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_isletme_sor_click_post);
        ...
        ClickPostRef2= FirebaseDatabase.getInstance().getReference().child("IsletmeSor").child(PostKey4);
    ...
    private void EditCurrentPost2(String description3) {
        AlertDialog.Builder builder=new AlertDialog.Builder(IsletmeSorClickPostActivity.this);
        builder.setTitle("DÜZENLE");
        final EditText InputField=new EditText(IsletmeSorClickPostActivity.this);
        ...
        builder.setPositiveButton("Güncelle", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(IsletmeSorClickPostActivity.this,"Post başarıyla güncellendi",Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void SendUserToMainActivity2() {
        Intent mainIntent = new Intent(IsletmeSorClickPostActivity.this,IsletmeSorActivity.class);
