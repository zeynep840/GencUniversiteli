...
public class TipProjeOnerileriPostsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tip_proje_onerileri_posts);
        init();
        ...
        backButton1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent geriIntent=new Intent( TipProjeOnerileriPostsActivity.this,TipProjeOnerileriActivity.class);
    ...
    private void ValidatePost1Info() {
        ...
        postsRef=FirebaseDatabase.getInstance().getReference().child("TipProjeOnerileri");
                ...
                postsRef.child(current_user_id+postRandom).updateChildren(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()){
                            startActivity(new Intent(TipProjeOnerileriPostsActivity.this,TipProjeOnerileriActivity.class));
                            finish();

                        }
                        else{
                            Toast.makeText(TipProjeOnerileriPostsActivity.this,"Eror",Toast.LENGTH_SHORT).show();
