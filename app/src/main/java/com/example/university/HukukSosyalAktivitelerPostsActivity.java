...
public class HukukSosyalAktivitelerPostsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hukuk_sosyal_aktiviteler_posts);
        init();
        ...
        backButton1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent geriIntent=new Intent( HukukSosyalAktivitelerPostsActivity.this,HukukSosyalAktivitelerActivity.class);
    ...
    private void ValidatePost1Info() {
        ...
        postsRef=FirebaseDatabase.getInstance().getReference().child("HukukSosyalAktiviteler");
                ...
                postsRef.child(current_user_id+postRandom).updateChildren(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()){
                            startActivity(new Intent(HukukSosyalAktivitelerPostsActivity.this,HukukSosyalAktivitelerActivity.class));
                            finish();

                        }
                        else{
                            Toast.makeText(HukukSosyalAktivitelerPostsActivity.this,"Eror",Toast.LENGTH_SHORT).show();
