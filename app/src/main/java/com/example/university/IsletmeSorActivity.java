...
public class IsletmeSorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_isletme_sor);
        PostsRef4= FirebaseDatabase.getInstance().getReference().child("IsletmeSor");
        ...
        getSupportActionBar().setTitle("İşletme Bölümü");
        camera4=(ImageButton)findViewById(R.id.camera4);
        camera4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent4=new Intent(IsletmeSorActivity.this,IsletmeSorPostsActivity.class);
    ...
    private void DisplayAllUserPosts4() {
        final FirebaseRecyclerAdapter<IsletmeSorPosts,IsletmeSorPostsViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<IsletmeSorPosts, IsletmeSorPostsViewHolder>(
                IsletmeSorPosts.class,
                R.layout.all_isletme_sor_post_layout,
                IsletmeSorPostsViewHolder.class,
                PostsRef4
        ) {
            @Override
            protected void populateViewHolder(IsletmeSorPostsViewHolder viewHolder, IsletmeSorPosts model, int position) {
                ...
                viewHolder.CommentPostButton2.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent commentPostIntent1=new Intent(IsletmeSorActivity.this,IsletmeCommentActivity.class);
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent clickPostIntent=new Intent(IsletmeSorActivity.this,IsletmeSorClickPostActivity.class);
    ...
    public static class IsletmeSorPostsViewHolder extends RecyclerView.ViewHolder {
        View mView;
        Button CommentPostButton2;


        public IsletmeSorPostsViewHolder(@NonNull View itemView) {
            super(itemView);
            mView = itemView;
