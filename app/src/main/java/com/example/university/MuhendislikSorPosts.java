...
public class MuhendislikSorPosts {
    public String postid2,postimage2,description2,profileimage,publisher2,date2,time2,username;
    public MuhendislikSorPosts(){

    }
    public MuhendislikSorPosts(String postid2,String date2,String time2,String publisher2,String username,String postimage2,String description2,String profileimage){
