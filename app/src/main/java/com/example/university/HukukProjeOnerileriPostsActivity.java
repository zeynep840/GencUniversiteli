...
public class HukukProjeOnerileriPostsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hukuk_proje_onerileri_posts);
        init();
        ...
        backButton1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent geriIntent=new Intent( HukukProjeOnerileriPostsActivity.this,HukukProjeOnerileriActivity.class);
    ...
    private void ValidatePost1Info() {
        ...
        postsRef=FirebaseDatabase.getInstance().getReference().child("HukukProjeOnerileri");
                ...
                postsRef.child(current_user_id+postRandom).updateChildren(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()){
                            startActivity(new Intent(HukukProjeOnerileriPostsActivity.this,HukukProjeOnerileriActivity.class));
                            finish();

                        }
                        else{
                            Toast.makeText(HukukProjeOnerileriPostsActivity.this,"Eror",Toast.LENGTH_SHORT).show();
