...
public class MuhendislikSosyalAktivitelerPostsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_muhendislik_sosyal_aktiviteler_posts);
        init();
        ...
        backButton1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent geriIntent=new Intent( MuhendislikSosyalAktivitelerPostsActivity.this,MuhendislikSosyalAktivitelerActivity.class);
    ...
    private void ValidatePost1Info() {
        ...
        postsRef=FirebaseDatabase.getInstance().getReference().child("MuhendislikSosyalAktiviteler");
                ...
                postsRef.child(current_user_id+postRandom).updateChildren(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()){
                            startActivity(new Intent(MuhendislikSosyalAktivitelerPostsActivity.this,MuhendislikSosyalAktivitelerActivity.class));
                            finish();

                        }
                        else{
                            Toast.makeText(MuhendislikSosyalAktivitelerPostsActivity.this,"Eror",Toast.LENGTH_SHORT).show();
