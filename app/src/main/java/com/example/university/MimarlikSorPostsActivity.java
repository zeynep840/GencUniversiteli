...
public class MimarlikSorPostsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mimarlik_sor_posts);
        init();
        ...
        backButton3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent geriIntent=new Intent(MimarlikSorPostsActivity.this,MimarlikActivity.class);
    ...
    private void ValidePost3Info() {
        ...
        postsRef3 = FirebaseDatabase.getInstance().getReference().child("MimarlikSor");
                ...
                postsRef3.child(current_user_id3 + postRandom3).updateChildren(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()){
                            startActivity(new Intent(MimarlikSorPostsActivity.this, MimarlikActivity.class));
                            finish();
                        }
                        else{
                            Toast.makeText(MimarlikSorPostsActivity.this,"Eror",Toast.LENGTH_SHORT).show();
